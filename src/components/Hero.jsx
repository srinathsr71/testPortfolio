            ...
            <div className="container hero-container">
                ...
                >
                    ...
                    >
                        ...
                        <span className="hero-name-gradient">Through Automation.</span>
                    </motion.h1>
                ...
                >
                    <div className="hero-orb">
                        ...
                        <div className="hero-float-card card-5">
                            <div className="float-card-icon" style={{ background: 'rgba(59, 130, 246, 0.15)' }}>🚀</div>
                            <span>Jenkins CI/CD</span>
                        </div>

                        {/* BDD Cucumber */}
                        <div className="hero-float-card card-6">
                            <div className="float-card-icon" style={{ background: 'rgba(16, 185, 129, 0.15)' }}>🥒</div>
                            <span>BDD Cucumber</span>
                        </div>

                        {/* Postman */}
                        <div className="hero-float-card card-7">
                            <div className="float-card-icon" style={{ background: 'rgba(255, 153, 51, 0.15)' }}>📮</div>
                            <span>Postman & RestAssured</span>
                        </div>

                        {/* Playwright */}
                        <div className="hero-float-card card-8">
                            <div className="float-card-icon" style={{ background: 'rgba(239, 68, 68, 0.15)' }}>🎭</div>
